...
| ----------- | ----------------------------- |
| Type        | <code>bool</code>             |
| Environment | <code>$WIRTUAL_SSH_STDIO</code> |
...
| ----------- | ------------------------------------- |
| Type        | <code>bool</code>                     |
| Environment | <code>$WIRTUAL_SSH_FORWARD_AGENT</code> |
...
| ----------- | ----------------------------------- |
| Type        | <code>bool</code>                   |
| Environment | <code>$WIRTUAL_SSH_FORWARD_GPG</code> |
...
| Environment | <code>$WIRTUAL_SSH_IDENTITY_AGENT</code> |
...
| Environment | <code>$WIRTUAL_WORKSPACE_POLL_INTERVAL</code> |
...
| Environment | <code>$WIRTUAL_SSH_WAIT</code> |
...
| ----------- | ------------------------------- |
| Type        | <code>bool</code>               |
| Environment | <code>$WIRTUAL_SSH_NO_WAIT</code> |
...
| ----------- | ------------------------------- |
| Type        | <code>string</code>             |
| Environment | <code>$WIRTUAL_SSH_LOG_DIR</code> |
...
| Environment | <code>$WIRTUAL_SSH_REMOTE_FORWARD</code> |
...
| ----------- | --------------------------- |
| Type        | <code>string-array</code>   |
| Environment | <code>$WIRTUAL_SSH_ENV</code> |
...
| ----------- | ----------------------------------------- |
| Type        | <code>bool</code>                         |
| Environment | <code>$WIRTUAL_SSH_DISABLE_AUTOSTART</code> |
