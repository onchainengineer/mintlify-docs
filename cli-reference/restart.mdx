...
```console
wirtual restart [flags] <workspace>
```
...
| Environment | <code>$WIRTUAL_BUILD_OPTION</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string-array</code>               |
| Environment | <code>$WIRTUAL_EPHEMERAL_PARAMETER</code> |
...
| ----------- | ----------------------------------------------- |
| Type        | <code>bool</code>                               |
| Environment | <code>$WIRTUAL_PROMPT_EPHEMERAL_PARAMETERS</code> |
