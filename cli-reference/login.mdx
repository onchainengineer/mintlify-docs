...
Authenticate with wirtual deployment

## Usage

```console
wirtual login [flags] [<url>]
```
...
| Environment | <code>$WIRTUAL_FIRST_USER_EMAIL</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string</code>                     |
| Environment | <code>$WIRTUAL_FIRST_USER_USERNAME</code> |
...
| ----------- | ---------------------------------------- |
| Type        | <code>string</code>                      |
| Environment | <code>$WIRTUAL_FIRST_USER_FULL_NAME</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string</code>                     |
| Environment | <code>$WIRTUAL_FIRST_USER_PASSWORD</code> |
...
| ----------- | ------------------------------------ |
| Type        | <code>bool</code>                    |
| Environment | <code>$WIRTUAL_FIRST_USER_TRIAL</code> |

Specifies whether a trial license should be provisioned for the wirtual deployment or not.
