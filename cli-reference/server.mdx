...
Start a wirtual server

## Usage

```console
wirtual server [flags]
```
...
| ----------- | --------------------------------- |
| Type        | <code>url</code>                  |
| Environment | <code>$WIRTUAL_ACCESS_URL</code>    |
| YAML        | <code>networking.accessURL</code> |

The URL that users will use to access the wirtual deployment.
...
| Environment | <code>$WIRTUAL_WILDCARD_ACCESS_URL</code>   |
...
| ----------- | ----------------------------------- |
| Type        | <code>url</code>                    |
| Environment | <code>$WIRTUAL_DOCS_URL</code>        |
| YAML        | <code>networking.docsURL</code>     |
| Default     | <code>https://docs.wirtual.dev</code> |
...
| ----------- | ------------------------------------------- |
| Type        | <code>bool</code>                           |
| Environment | <code>$WIRTUAL_REDIRECT_TO_ACCESS_URL</code>  |
...
| ----------- | ---------------------------------------- |
| Type        | <code>string</code>                      |
| Environment | <code>$WIRTUAL_HTTP_ADDRESS</code>         |
...
| Environment | <code>$WIRTUAL_TLS_ADDRESS</code>     |
...
| ----------- | ---------------------------------- |
| Type        | <code>bool</code>                  |
| Environment | <code>$WIRTUAL_TLS_ENABLE</code>     |
...
| Environment | <code>$WIRTUAL_TLS_CERT_FILE</code>     |
...
| ----------- | ---------------------------------------- |
| Type        | <code>string</code>                      |
| Environment | <code>$WIRTUAL_TLS_CLIENT_CA_FILE</code>   |
...
| ----------- | -------------------------------------- |
| Type        | <code>string</code>                    |
| Environment | <code>$WIRTUAL_TLS_CLIENT_AUTH</code>    |
...
| ----------- | ------------------------------------ |
| Type        | <code>string-array</code>            |
| Environment | <code>$WIRTUAL_TLS_KEY_FILE</code>     |
...
| ----------- | -------------------------------------- |
| Type        | <code>string</code>                    |
| Environment | <code>$WIRTUAL_TLS_MIN_VERSION</code>    |
...
| ----------- | ------------------------------------------ |
| Type        | <code>string</code>                        |
| Environment | <code>$WIRTUAL_TLS_CLIENT_CERT_FILE</code>   |
...
| ----------- | ----------------------------------------- |
| Type        | <code>string</code>                       |
| Environment | <code>$WIRTUAL_TLS_CLIENT_KEY_FILE</code>   |
...
| ----------- | -------------------------------------- |
| Type        | <code>string-array</code>              |
| Environment | <code>$WIRTUAL_TLS_CIPHERS</code>        |
...
| ----------- | --------------------------------------------------- |
| Type        | <code>bool</code>                                   |
| Environment | <code>$WIRTUAL_TLS_ALLOW_INSECURE_CIPHERS</code>      |
...
| ----------- | -------------------------------------- |
| Type        | <code>bool</code>                      |
| Environment | <code>$WIRTUAL_DERP_SERVER_ENABLE</code> |
...
| ----------- | ------------------------------------------- |
| Type        | <code>string</code>                         |
| Environment | <code>$WIRTUAL_DERP_SERVER_REGION_NAME</code> |
| YAML        | <code>networking.derp.regionName</code>     |
| Default     | <code>wirtual Embedded Relay</code>           |
...
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Type        | <code>string-array</code>                                                                                                                |
| Environment | <code>$WIRTUAL_DERP_SERVER_STUN_ADDRESSES</code>                                                                                           |
...
| ----------- | ----------------------------------------- |
| Type        | <code>url</code>                          |
| Environment | <code>$WIRTUAL_DERP_SERVER_RELAY_URL</code> |
...
| ----------- | -------------------------------------------- |
| Type        | <code>bool</code>                            |
| Environment | <code>$WIRTUAL_DERP_FORCE_WEBSOCKETS</code>    |
...
| ----------- | ----------------------------------- |
| Type        | <code>string</code>                 |
| Environment | <code>$WIRTUAL_DERP_CONFIG_URL</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string</code>                     |
| Environment | <code>$WIRTUAL_DERP_CONFIG_PATH</code>    |
...
| ----------- | -------------------------------------------- |
| Type        | <code>bool</code>                            |
| Environment | <code>$WIRTUAL_PROMETHEUS_ENABLE</code>        |
...
| ----------- | --------------------------------------------- |
| Type        | <code>host:port</code>                        |
| Environment | <code>$WIRTUAL_PROMETHEUS_ADDRESS</code>        |
...
| ----------- | --------------------------------------------------------- |
| Type        | <code>bool</code>                                         |
| Environment | <code>$WIRTUAL_PROMETHEUS_COLLECT_AGENT_STATS</code>        |
...
| ----------- | -------------------------------------------------------------- |
| Type        | <code>string-array</code>                                      |
| Environment | <code>$WIRTUAL_PROMETHEUS_AGGREGATE_AGENT_STATS_BY</code>        |
...
| ----------- | -------------------------------------------------------- |
| Type        | <code>bool</code>                                        |
| Environment | <code>$WIRTUAL_PROMETHEUS_COLLECT_DB_METRICS</code>        |
...
| ----------- | --------------------------------------- |
| Type        | <code>bool</code>                       |
| Environment | <code>$WIRTUAL_PPROF_ENABLE</code>        |
...
| ----------- | ---------------------------------------- |
| Type        | <code>host:port</code>                   |
| Environment | <code>$WIRTUAL_PPROF_ADDRESS</code>        |
...
| ----------- | ------------------------------------------- |
| Type        | <code>string</code>                         |
| Environment | <code>$WIRTUAL_OAUTH2_GITHUB_CLIENT_ID</code> |
...
| ----------- | ----------------------------------------------- |
| Type        | <code>string</code>                             |
| Environment | <code>$WIRTUAL_OAUTH2_GITHUB_CLIENT_SECRET</code> |
...
| ----------- | ---------------------------------------------- |
| Type        | <code>string-array</code>                      |
| Environment | <code>$WIRTUAL_OAUTH2_GITHUB_ALLOWED_ORGS</code> |
...
| ----------- | ----------------------------------------------- |
| Type        | <code>string-array</code>                       |
| Environment | <code>$WIRTUAL_OAUTH2_GITHUB_ALLOWED_TEAMS</code> |
...
| ----------- | ----------------------------------------------- |
| Type        | <code>bool</code>                               |
| Environment | <code>$WIRTUAL_OAUTH2_GITHUB_ALLOW_SIGNUPS</code> |
...
| ----------- | ------------------------------------------------ |
| Type        | <code>bool</code>                                |
| Environment | <code>$WIRTUAL_OAUTH2_GITHUB_ALLOW_EVERYONE</code> |
...
| ----------- | ----------------------------------------------------- |
| Type        | <code>string</code>                                   |
| Environment | <code>$WIRTUAL_OAUTH2_GITHUB_ENTERPRISE_BASE_URL</code> |
...
| ----------- | -------------------------------------- |
| Type        | <code>bool</code>                      |
| Environment | <code>$WIRTUAL_OIDC_ALLOW_SIGNUPS</code> |
...
| ----------- | ---------------------------------- |
| Type        | <code>string</code>                |
| Environment | <code>$WIRTUAL_OIDC_CLIENT_ID</code> |
...
| ----------- | -------------------------------------- |
| Type        | <code>string</code>                    |
| Environment | <code>$WIRTUAL_OIDC_CLIENT_SECRET</code> |
...
| ----------- | ---------------------------------------- |
| Type        | <code>string</code>                      |
| Environment | <code>$WIRTUAL_OIDC_CLIENT_KEY_FILE</code> |
...
| ----------- | ----------------------------------------- |
| Type        | <code>string</code>                       |
| Environment | <code>$WIRTUAL_OIDC_CLIENT_CERT_FILE</code> |
...
| ----------- | ------------------------------------- |
| Type        | <code>string-array</code>             |
| Environment | <code>$WIRTUAL_OIDC_EMAIL_DOMAIN</code> |
...
| ----------- | ----------------------------------- |
| Type        | <code>string</code>                 |
| Environment | <code>$WIRTUAL_OIDC_ISSUER_URL</code> |
...
| ----------- | --------------------------------- |
| Type        | <code>string-array</code>         |
| Environment | <code>$WIRTUAL_OIDC_SCOPES</code>   |
...
| ----------- | ---------------------------------------------- |
| Type        | <code>bool</code>                              |
| Environment | <code>$WIRTUAL_OIDC_IGNORE_EMAIL_VERIFIED</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string</code>                     |
| Environment | <code>$WIRTUAL_OIDC_USERNAME_FIELD</code> |
...
| ----------- | ----------------------------------- |
| Type        | <code>string</code>                 |
| Environment | <code>$WIRTUAL_OIDC_NAME_FIELD</code> |
...
| ----------- | ------------------------------------ |
| Type        | <code>string</code>                  |
| Environment | <code>$WIRTUAL_OIDC_EMAIL_FIELD</code> |
...
| Environment | <code>$WIRTUAL_OIDC_AUTH_URL_PARAMS</code> |
...
| ----------- | ---------------------------------------- |
| Type        | <code>bool</code>                        |
| Environment | <code>$WIRTUAL_OIDC_IGNORE_USERINFO</code> |
...
| ----------- | ------------------------------------ |
| Type        | <code>string</code>                  |
| Environment | <code>$WIRTUAL_OIDC_GROUP_FIELD</code> |
...
| ----------- | -------------------------------------- |
| Type        | <code>struct[map[string]string]</code> |
| Environment | <code>$WIRTUAL_OIDC_GROUP_MAPPING</code> |
| YAML        | <code>oidc.groupMapping</code>         |
| Default     | <code>{}</code>                        |

A map of OIDC group IDs and the group in wirtual it should map to. This is useful for when OIDC providers only return group IDs.
...
| ----------- | ------------------------------------------ |
| Type        | <code>bool</code>                          |
| Environment | <code>$WIRTUAL_OIDC_GROUP_AUTO_CREATE</code> |
...
| Environment | <code>$WIRTUAL_OIDC_GROUP_REGEX_FILTER</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string-array</code>               |
| Environment | <code>$WIRTUAL_OIDC_ALLOWED_GROUPS</code> |
...
| ----------- | ---------------------------------------- |
| Type        | <code>string</code>                      |
| Environment | <code>$WIRTUAL_OIDC_USER_ROLE_FIELD</code> |
...
| ----------- | ------------------------------------------ |
| Type        | <code>struct[map[string][]string]</code>   |
| Environment | <code>$WIRTUAL_OIDC_USER_ROLE_MAPPING</code> |
| YAML        | <code>oidc.userRoleMapping</code>          |
| Default     | <code>{}</code>                            |

A map of the OIDC passed in user roles and the groups in wirtual it should map to. This is useful if the group names do not match. If mapped to the empty string, the role will ignored.
...
| ----------- | ------------------------------------------ |
| Type        | <code>string-array</code>                  |
| Environment | <code>$WIRTUAL_OIDC_USER_ROLE_DEFAULT</code> |
...
| ----------- | ------------------------------------- |
| Type        | <code>string</code>                   |
| Environment | <code>$WIRTUAL_OIDC_SIGN_IN_TEXT</code> |
...
| ----------- | --------------------------------- |
| Type        | <code>url</code>                  |
| Environment | <code>$WIRTUAL_OIDC_ICON_URL</code> |
...
| ----------- | ---------------------------------------------- |
| Type        | <code>string</code>                            |
| Environment | <code>$WIRTUAL_OIDC_SIGNUPS_DISABLED_TEXT</code> |
...
| ----------- | ----------------------------------------------------- |
| Type        | <code>bool</code>                                     |
| Environment | <code>$WIRTUAL_DANGEROUS_OIDC_SKIP_ISSUER_CHECKS</code> |
...
| ----------- | ------------------------------------ |
| Type        | <code>bool</code>                    |
| Environment | <code>$WIRTUAL_TELEMETRY_ENABLE</code> |
| YAML        | <code>telemetry.enable</code>        |
| Default     | <code>true</code>                    |

Whether telemetry is enabled or not. wirtual collects anonymized usage data to help improve our product.
...
| ----------- | ----------------------------------------- |
| Type        | <code>bool</code>                         |
| Environment | <code>$WIRTUAL_TRACE_ENABLE</code>          |
...
| ----------- | ------------------------------------------- |
| Type        | <code>string</code>                         |
| Environment | <code>$WIRTUAL_TRACE_HONEYCOMB_API_KEY</code> |
...
| ----------- | ---------------------------------------------- |
| Type        | <code>bool</code>                              |
| Environment | <code>$WIRTUAL_TRACE_LOGS</code>                 |
...
| ----------- | --------------------------------------- |
| Type        | <code>int</code>                        |
| Environment | <code>$WIRTUAL_PROVISIONER_DAEMONS</code> |
...
| Environment | <code>$WIRTUAL_PROVISIONER_DAEMON_POLL_INTERVAL</code> |
...
| ----------- | -------------------------------------------------- |
| Type        | <code>duration</code>                              |
| Environment | <code>$WIRTUAL_PROVISIONER_DAEMON_POLL_JITTER</code> |
...
| ----------- | ----------------------------------------------------- |
| Type        | <code>duration</code>                                 |
| Environment | <code>$WIRTUAL_PROVISIONER_FORCE_CANCEL_INTERVAL</code> |
...
| ----------- | ------------------------------------------ |
| Type        | <code>string</code>                        |
| Environment | <code>$WIRTUAL_PROVISIONER_DAEMON_PSK</code> |

Pre-shared key to authenticate external provisioner daemons to wirtual server.
...
| ----------- | ----------------------------------------- |
| Type        | <code>string-array</code>                 |
| Environment | <code>$WIRTUAL_LOG_FILTER</code>            |
...
| ----------- | -------------------------------------------- |
| Type        | <code>string</code>                          |
| Environment | <code>$WIRTUAL_LOGGING_HUMAN</code>            |
...
| ----------- | ------------------------------------------- |
| Type        | <code>string</code>                         |
| Environment | <code>$WIRTUAL_LOGGING_JSON</code>            |
...
| ----------- | -------------------------------------------------- |
| Type        | <code>string</code>                                |
| Environment | <code>$WIRTUAL_LOGGING_STACKDRIVER</code>            |
...
| ----------- | ----------------------------------------------------------- |
| Type        | <code>bool</code>                                           |
| Environment | <code>$WIRTUAL_ENABLE_TERRAFORM_DEBUG_MODE</code>             |
...
| ----------- | ------------------------------------------------ |
| Type        | <code>string-array</code>                        |
| Environment | <code>$WIRTUAL_ADDITIONAL_CSP_POLICY</code>        |
| YAML        | <code>networking.http.additionalCSPPolicy</code> |

wirtual configures a Content Security Policy (CSP) to protect against XSS attacks. This setting allows you to add additional CSP directives, which can open the attack surface of the deployment. Format matches the CSP directive format, e.g. --additional-csp-policy="script-src https://example.com".
...
| ----------- | ---------------------------------------------------- |
| Type        | <code>bool</code>                                    |
| Environment | <code>$WIRTUAL_DANGEROUS_ALLOW_PATH_APP_SHARING</code> |

Allow workspace apps that are not served from subdomains to be shared. Path-based app sharing is DISABLED by default for security purposes. Path-based apps can make requests to the wirtual API and pose a security risk when the workspace serves malicious JavaScript. Path-based apps can be disabled entirely with --disable-path-apps for further security.
...
| ----------- | -------------------------------------------------------------- |
| Type        | <code>bool</code>                                              |
| Environment | <code>$WIRTUAL_DANGEROUS_ALLOW_PATH_APP_SITE_OWNER_ACCESS</code> |

Allow site-owners to access workspace apps from workspaces they do not own. Owners cannot access path-based apps they do not own by default. Path-based apps can make requests to the wirtual API and pose a security risk when the workspace serves malicious JavaScript. Path-based apps can be disabled entirely with --disable-path-apps for further security.
...
| ----------- | ------------------------------- |
| Type        | <code>string-array</code>       |
| Environment | <code>$WIRTUAL_EXPERIMENTS</code> |
...
| ----------- | -------------------------------- |
| Type        | <code>bool</code>                |
| Environment | <code>$WIRTUAL_UPDATE_CHECK</code> |
| YAML        | <code>updateCheck</code>         |
| Default     | <code>false</code>               |

Periodically check for new releases of wirtual and inform the owner. The check is performed once per day.
...
| ----------- | --------------------------------------------- |
| Type        | <code>duration</code>                         |
| Environment | <code>$WIRTUAL_MAX_TOKEN_LIFETIME</code>        |
...
| ----------- | ------------------------------------------ |
| Type        | <code>duration</code>                      |
| Environment | <code>$WIRTUAL_DEFAULT_TOKEN_LIFETIME</code> |
...
| ----------- | ---------------------------------- |
| Type        | <code>bool</code>                  |
| Environment | <code>$WIRTUAL_SWAGGER_ENABLE</code> |
...
| ----------- | ------------------------------------------- |
| Type        | <code>string-array</code>                   |
| Environment | <code>$WIRTUAL_PROXY_TRUSTED_HEADERS</code>   |
...
| ----------- | ------------------------------------------- |
| Type        | <code>string-array</code>                   |
| Environment | <code>$WIRTUAL_PROXY_TRUSTED_ORIGINS</code>   |
...
| ----------- | ----------------------------------- |
| Type        | <code>string</code>                 |
| Environment | <code>$WIRTUAL_CACHE_DIRECTORY</code> |
| YAML        | <code>cacheDir</code>               |
| Default     | <code>~/.cache/wirtual</code>         |

The directory to cache temporary files. If unspecified and $CACHE_DIRECTORY is set, it will be used for compatibility with systemd. This directory is NOT safe to be configured as a shared directory across wirtuald/provisionerd replicas.
...
| ----------- | ------------------------------------- |
| Type        | <code>string</code>                   |
| Environment | <code>$WIRTUAL_PG_CONNECTION_URL</code> |

URL of a PostgreSQL database. If empty, PostgreSQL binaries will be downloaded from Maven (https://repo1.maven.org/maven2) and store all data in the config root. Access the built-in database with "wirtual server postgres-builtin-url".
...
| Environment | <code>$WIRTUAL_PG_AUTH</code>      |
...
| ----------- | ---------------------------------------- |
| Type        | <code>bool</code>                        |
| Environment | <code>$WIRTUAL_SECURE_AUTH_COOKIE</code>   |
...
| ----------- | ---------------------------------------- |
| Type        | <code>string</code>                      |
| Environment | <code>$WIRTUAL_TERMS_OF_SERVICE_URL</code> |
...
| ----------- | --------------------------------------------------- |
| Type        | <code>int</code>                                    |
| Environment | <code>$WIRTUAL_STRICT_TRANSPORT_SECURITY</code>       |
...
| ----------- | ---------------------------------------------------------- |
| Type        | <code>string-array</code>                                  |
| Environment | <code>$WIRTUAL_STRICT_TRANSPORT_SECURITY_OPTIONS</code>      |
...
| ----------- | ---------------------------------------- |
| Type        | <code>string</code>                      |
| Environment | <code>$WIRTUAL_SSH_KEYGEN_ALGORITHM</code> |
...
| ----------- | ----------------------------------- |
| Type        | <code>bool</code>                   |
| Environment | <code>$WIRTUAL_BROWSER_ONLY</code>    |
| YAML        | <code>networking.browserOnly</code> |

Whether wirtual only allows connections to workspaces via the browser.
...
| ----------- | ------------------------------------ |
| Type        | <code>string</code>                  |
| Environment | <code>$WIRTUAL_SCIM_AUTH_HEADER</code> |
...
| ----------- | -------------------------------------------------- |
| Type        | <code>string-array</code>                          |
| Environment | <code>$WIRTUAL_EXTERNAL_TOKEN_ENCRYPTION_KEYS</code> |

Encrypt OIDC and Git authentication tokens with AES-256-GCM in the database. The value must be a comma-separated list of base64-encoded keys. Each key, when base64-decoded, must be exactly 32 bytes in length. The first key will be used to encrypt new values. Subsequent keys will be used as a fallback when decrypting. During normal operation it is recommended to only set one key unless you are in the process of rotating keys with the `wirtual server dbcrypt rotate` command.
...
| ----------- | ------------------------------------- |
| Type        | <code>bool</code>                     |
| Environment | <code>$WIRTUAL_DISABLE_PATH_APPS</code> |
| YAML        | <code>disablePathApps</code>          |

Disable workspace apps that are not served from subdomains. Path-based apps can make requests to the wirtual API and pose a security risk when the workspace serves malicious JavaScript. This is recommended for security purposes if a --wildcard-access-url is configured.
...
| ----------- | -------------------------------------------------- |
| Type        | <code>bool</code>                                  |
| Environment | <code>$WIRTUAL_DISABLE_OWNER_WORKSPACE_ACCESS</code> |
...
| ----------- | -------------------------------------------- |
| Type        | <code>duration</code>                        |
| Environment | <code>$WIRTUAL_SESSION_DURATION</code>         |
...
| ----------- | -------------------------------------------------------- |
| Type        | <code>bool</code>                                        |
| Environment | <code>$WIRTUAL_DISABLE_SESSION_EXPIRY_REFRESH</code>       |
...
| Environment | <code>$WIRTUAL_CONFIG_PATH</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string</code>                     |
| Environment | <code>$WIRTUAL_SSH_HOSTNAME_PREFIX</code> |
| YAML        | <code>client.sshHostnamePrefix</code>   |
| Default     | <code>wirtual.</code>                     |
...
| ----------- | -------------------------------------- |
| Type        | <code>string-array</code>              |
| Environment | <code>$WIRTUAL_SSH_CONFIG_OPTIONS</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string</code>                     |
| Environment | <code>$WIRTUAL_CLI_UPGRADE_MESSAGE</code> |
| YAML        | <code>client.cliUpgradeMessage</code>   |

The upgrade message to display to users when a client/server mismatch is detected. By default it instructs users to update using 'curl -L https://wirtual.dev/install.sh | sh'.
...
|             |                                            |
| ----------- | ------------------------------------------ |
| Type        | <code>struct[[]wirtualsdk.LinkConfig]</code> |
| Environment | <code>$WIRTUAL_SUPPORT_LINKS</code>          |
...
| ----------- | ------------------------------------------------ |
| Type        | <code>duration</code>                            |
| Environment | <code>$WIRTUAL_PROXY_HEALTH_INTERVAL</code>        |
| YAML        | <code>networking.http.proxyHealthInterval</code> |
| Default     | <code>1m0s</code>                                |

The interval in which wirtuald should be checking the status of workspace proxies.
...
| ----------- | ------------------------------------------------------------- |
| Type        | <code>string</code>                                           |
| Environment | <code>$WIRTUAL_QUIET_HOURS_DEFAULT_SCHEDULE</code>              |
...
| ----------- | --------------------------------------------------------- |
| Type        | <code>bool</code>                                         |
| Environment | <code>$WIRTUAL_ALLOW_CUSTOM_QUIET_HOURS</code>              |
...
| ----------- | ----------------------------------------- |
| Type        | <code>string</code>                       |
| Environment | <code>$WIRTUAL_WEB_TERMINAL_RENDERER</code> |
...
| ----------- | ------------------------------------------- |
| Type        | <code>bool</code>                           |
| Environment | <code>$WIRTUAL_ALLOW_WORKSPACE_RENAMES</code> |
...
| ----------- | ---------------------------------------------- |
| Type        | <code>duration</code>                          |
| Environment | <code>$WIRTUAL_HEALTH_CHECK_REFRESH</code>       |
...
| ----------- | -------------------------------------------------------- |
| Type        | <code>duration</code>                                    |
| Environment | <code>$WIRTUAL_HEALTH_CHECK_THRESHOLD_DATABASE</code>      |
...
| ----------- | ------------------------------ |
| Type        | <code>string</code>            |
| Environment | <code>$WIRTUAL_EMAIL_FROM</code> |
...
| ----------- | ----------------------------------- |
| Type        | <code>string</code>                 |
| Environment | <code>$WIRTUAL_EMAIL_SMARTHOST</code> |
...
| ----------- | ------------------------------- |
| Type        | <code>string</code>             |
| Environment | <code>$WIRTUAL_EMAIL_HELLO</code> |
...
| ----------- | ----------------------------------- |
| Type        | <code>bool</code>                   |
| Environment | <code>$WIRTUAL_EMAIL_FORCE_TLS</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string</code>                     |
| Environment | <code>$WIRTUAL_EMAIL_AUTH_IDENTITY</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string</code>                     |
| Environment | <code>$WIRTUAL_EMAIL_AUTH_USERNAME</code> |
...
| ----------- | --------------------------------------- |
| Type        | <code>string</code>                     |
| Environment | <code>$WIRTUAL_EMAIL_AUTH_PASSWORD</code> |
...
| ----------- | -------------------------------------------- |
| Type        | <code>string</code>                          |
| Environment | <code>$WIRTUAL_EMAIL_AUTH_PASSWORD_FILE</code> |
...
| ----------- | -------------------------------------- |
| Type        | <code>bool</code>                      |
| Environment | <code>$WIRTUAL_EMAIL_TLS_STARTTLS</code> |
...
| ----------- | ---------------------------------------- |
| Type        | <code>string</code>                      |
| Environment | <code>$WIRTUAL_EMAIL_TLS_SERVERNAME</code> |
...
| ----------- | ---------------------------------------------- |
| Type        | <code>bool</code>                              |
| Environment | <code>$WIRTUAL_EMAIL_TLS_SKIPVERIFY</code>       |
...
| ----------- | ---------------------------------------- |
| Type        | <code>string</code>                      |
| Environment | <code>$WIRTUAL_EMAIL_TLS_CACERTFILE</code> |
...
| ----------- | -------------------------------------- |
| Type        | <code>string</code>                    |
| Environment | <code>$WIRTUAL_EMAIL_TLS_CERTFILE</code> |
...
| ----------- | ----------------------------------------- |
| Type        | <code>string</code>                       |
| Environment | <code>$WIRTUAL_EMAIL_TLS_CERTKEYFILE</code> |
...
| ----------- | ---------------------------------------- |
| Type        | <code>string</code>                      |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_METHOD</code> |
...
| ----------- | -------------------------------------------------- |
| Type        | <code>duration</code>                              |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_DISPATCH_TIMEOUT</code> |
...
| ----------- | -------------------------------------------- |
| Type        | <code>string</code>                          |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_FROM</code> |
...
| ----------- | ------------------------------------------------- |
| Type        | <code>string</code>                               |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_SMARTHOST</code> |
...
| ----------- | --------------------------------------------- |
| Type        | <code>string</code>                           |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_HELLO</code> |
...
| ----------- | ------------------------------------------------- |
| Type        | <code>bool</code>                                 |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_FORCE_TLS</code> |
...
| ----------- | ----------------------------------------------------- |
| Type        | <code>string</code>                                   |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_AUTH_IDENTITY</code> |
...
| ----------- | ----------------------------------------------------- |
| Type        | <code>string</code>                                   |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_AUTH_USERNAME</code> |
...
| ----------- | ----------------------------------------------------- |
| Type        | <code>string</code>                                   |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_AUTH_PASSWORD</code> |
...
| ----------- | ---------------------------------------------------------- |
| Type        | <code>string</code>                                        |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_AUTH_PASSWORD_FILE</code> |
...
| ----------- | ---------------------------------------------------- |
| Type        | <code>bool</code>                                    |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_TLS_STARTTLS</code> |
...
| ----------- | ------------------------------------------------------ |
| Type        | <code>string</code>                                    |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_TLS_SERVERNAME</code> |
...
| ----------- | ------------------------------------------------------------ |
| Type        | <code>bool</code>                                            |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_TLS_SKIPVERIFY</code>       |
...
| ----------- | ------------------------------------------------------ |
| Type        | <code>string</code>                                    |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_TLS_CACERTFILE</code> |
...
| ----------- | ---------------------------------------------------- |
| Type        | <code>string</code>                                  |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_TLS_CERTFILE</code> |
...
| ----------- | ------------------------------------------------------- |
| Type        | <code>string</code>                                     |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_EMAIL_TLS_CERTKEYFILE</code> |
...
| ----------- | -------------------------------------------------- |
| Type        | <code>url</code>                                   |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_WEBHOOK_ENDPOINT</code> |
...
| ----------- | --------------------------------------------------- |
| Type        | <code>int</code>                                    |
| Environment | <code>$WIRTUAL_NOTIFICATIONS_MAX_SEND_ATTEMPTS</code> |
