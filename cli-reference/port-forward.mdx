...
```console
wirtual port-forward [flags] <workspace>
```
...
local machine:
     ...
     $ wirtual port-forward <workspace> --tcp 5678:1234

  - Port forward a single UDP port from port 9000 to port 9000 on your local
machine:

     $ wirtual port-forward <workspace> --udp 9000

  - Port forward multiple TCP ports and a UDP port:

     $ wirtual port-forward <workspace> --tcp 8080:8080 --tcp 9000:3000 --udp 5353:53

  - Port forward multiple ports (TCP or UDP) in condensed syntax:

     $ wirtual port-forward <workspace> --tcp 8080,9000:3000,9090-9092,10000-10002:10010-10012

  - Port forward specifying the local address to bind to:

     $ wirtual port-forward <workspace> --tcp 1.2.3.4:8080:8080
```
...
| Environment | <code>$WIRTUAL_PORT_FORWARD_TCP</code> |
...
| ----------- | ------------------------------------ |
| Type        | <code>string-array</code>            |
| Environment | <code>$WIRTUAL_PORT_FORWARD_UDP</code> |
