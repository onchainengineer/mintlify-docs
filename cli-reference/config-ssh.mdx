...
workspaces:
     ...
     $ wirtual config-ssh -o ForwardAgent=yes

  - You can use --dry-run (or -n) to see the changes that would be made:

     $ wirtual config-ssh --dry-run
```
...
| Environment | <code>$WIRTUAL_SSH_CONFIG_FILE</code> |
...
| ----------- | ------------------------------------------ |
| Type        | <code>string</code>                        |
| Environment | <code>$WIRTUAL_SSH_CONFIG_BINARY_PATH</code> |
...
| Environment | <code>$WIRTUAL_SSH_CONFIG_OPTS</code> |
...
| ----------- | ------------------------------- |
| Type        | <code>bool</code>               |
| Environment | <code>$WIRTUAL_SSH_DRY_RUN</code> |
...
| ----------- | -------------------------------------------- |
| Type        | <code>bool</code>                            |
| Environment | <code>$WIRTUAL_SSH_USE_PREVIOUS_OPTIONS</code> |
...
| ----------- | --------------------------------------------- |
| Type        | <code>string</code>                           |
| Environment | <code>$WIRTUAL_CONFIGSSH_SSH_HOST_PREFIX</code> |
...
| Environment | <code>$WIRTUAL_CONFIGSSH_WAIT</code> |
...
| ----------- | ----------------------------------------------- |
| Type        | <code>bool</code>                               |
| Environment | <code>$WIRTUAL_CONFIGSSH_DISABLE_AUTOSTART</code> |
